          ...
          <Dialog.Title className='text-3xl text-white font-black'>Publique Um anúncio</Dialog.Title>
              ...
              <form onSubmit={handleCreateAd} className='mt-8 flex flex-col gap-4' >
                  ...
                  <div className='flex flex-col gap-2'>
                    ...
                    defaultValue="">
                        <option disabled value="">Selecione o game que desejar jogar</option>
                  ...
                  <div className='flex flex-col gap-2'>
                      ...
                      <Input id="name" name='name' type="text" placeholder='Qual seu Nickname dentro do jogo?'/>
                  </div>
                  ...
                  <div className='flex gap-6'>
                      <div className='flex flex-col gap2'>
                          ...
                          <div >
                            ...
                            <ToggleGroup.Item value="1" className={`w-8 h-8 rounded ${ weekDays.includes('1') ? 'bg-violet-500' : 'bg-zinc-900'}`} title='Sengunda'>S</ToggleGroup.Item>
                  ...
                  <label className='mt-2 flex gap-2 text-sm items-center'>
                      <Checkbox.Root checked={useVoiceChannel} onCheckedChange={(Checked)=>{Checked === true ? setUseVoiceChannel(true) : setUseVoiceChannel(false)}} className="w-6 h-6 p-1 rounded bg-zinc-900">
